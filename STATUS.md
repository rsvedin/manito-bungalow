...
next_step: "Commit+push SEO sweep (uncommitted in working tree); Ryan: test booking through widget, re-point GVR to self-hosted site; then Batch 2 blog posts."
blocker: null
...
## Log
- 2026-07-03: SEO/launch-polish sweep (session crashed mid-work, recovered + finished): sitemap.xml, robots.txt, 404 page, /privacy + /house-rules pages, canonical URLs + OG/Twitter meta on all pages, BlogPosting JSON-LD, og-home.jpg (1200x630) generated in prebuild, all 36 blog cover images de-hotlinked to local /blog/ assets, footer year dynamic + legal links wired. Build passes (45 pages). NOT yet committed.
